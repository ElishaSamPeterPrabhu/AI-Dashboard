...
const ModusWcSideNavigation$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcSideNavigation extends H {
    ...
    render() {
        return (h(Host, { key: '95bfb8c27ee81fa0407e3f644d95ad1539bd2214' }, h("nav", Object.assign({ key: '63a9cace2dc6a529eb054bc970990a1e3465512c' }, this.inheritedAttributes, { class: this.getClasses(), ref: (el) => (this.navRef = el), style: { width: this.expanded ? this.maxWidth : this.minWidth } }), h("div", { key: '3160d4fc75508c0fdec85633b70961682cf3de7c', class: "side-navigation-content" }, h("slot", { key: '28c482ab7ab32ddec78e5745139deb90eb0adf64' })))));
    }
    get el() { return this; }
