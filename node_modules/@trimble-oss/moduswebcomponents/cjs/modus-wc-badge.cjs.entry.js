...
const ModusWcBadge = class {
    ...
    render() {
        ...
        const role = 'role' in this.inheritedAttributes
            ...
            : defaultRole;
        return (index.h(index.Host, { key: '019ea0b40cd01fdcc170edd122ab9a76cf35456a' }, index.h("span", Object.assign({ key: '068dee65942ca7561310457a40b498e647bd3b4b', class: this.getClasses() }, this.inheritedAttributes, { role: role }), index.h("slot", { key: 'e6e51e1cfa0181069314bba63c9d8913a804deaf' }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcBadge.style = modusWcBadgeCss;

exports.modus_wc_badge = ModusWcBadge;
