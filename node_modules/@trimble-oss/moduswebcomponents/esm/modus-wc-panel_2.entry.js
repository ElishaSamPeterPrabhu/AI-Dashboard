...
const ModusWCTypography = class {
    ...
    render() {
        ...
        return (h(Host, { key: '82d58622f045d2ffbd5a7501c85bf3e389eca805' }, h(Element, Object.assign({ key: 'ff26beedd9ccfbf6621b267229991a328f1d2646', class: this.getClasses() }, this.inheritedAttributes), h("slot", { key: '4e75723c2e855ba1dddd837689acd3902063ed19' }, this.label))));
    }
    get el() { return getElement(this); }
};
