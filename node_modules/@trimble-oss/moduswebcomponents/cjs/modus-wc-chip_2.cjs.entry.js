...
const CancelCircleSolidIcon = ({ className, onClick, }) => (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", class: `mi-solid mi-cancel-circle ${className || ''}`, onClick: onClick || undefined, viewBox: "0 0 24 24" },
...
const ModusWcChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6634584820468d84c0622ca69c45a508eafc0a63' }, index.h("button", Object.assign({ key: '1a23b1951e454d7e08cb1b3e0a6186ff23b1dd5e', "aria-disabled": this.disabled, class: this.getClasses(), disabled: this.disabled, onClick: this.handleChipClick, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, tabIndex: 0, type: "button" }, this.inheritedAttributes), index.h("slot", { key: 'f1542dcb3dcaa7dc3f691d240fa28c4eaf595285' }), this.label && index.h("span", { key: '053cca10f2457e47317a595e4c293455efe9d4b3', class: "modus-wc-chip-label" }, this.label), this.showRemove && (index.h(CancelCircleSolidIcon, { key: 'c65a160b48dc0448e896f3519cfce888348a9861', className: "modus-wc-chip-remove-icon", onClick: this.handleChipRemove })))));
    }
