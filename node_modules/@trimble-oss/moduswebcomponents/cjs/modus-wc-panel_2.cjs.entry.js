...
const ModusWcPanel = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8eca46effdba5d4c7c027a78d98e8914247d0187' }, index.h("div", Object.assign({ key: '106cf95c53ce95e4afa6a58845b979d575b3b318', class: this.getClasses(), style: { width: this.width, height: this.height } }, this.inheritedAttributes), index.h("div", { key: '200d9a028744c3027fea736461d50c27eca1ad31', class: "modus-wc-panel-header" }, index.h("slot", { key: '6ef2682a8d4eeb0f253ac6602da9a980b026be84', name: "header" })), index.h("div", { key: '61b44ce89e87e1364a18fb366f464ee25881a5c5', class: "modus-wc-panel-body" }, index.h("slot", { key: '4c6c82a0ad09e81b74dbe9c478f5793eaac702ee', name: "body" })), index.h("div", { key: '2806ffb3225c9c361b55b12e9088cb4326cbf463', class: "modus-wc-panel-footer" }, index.h("slot", { key: '577fadfaeb76f7c2f475685756b7da6dbb5c05fb', name: "footer" })))));
    }
...
const ModusWCTypography = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '82d58622f045d2ffbd5a7501c85bf3e389eca805' }, index.h(Element, Object.assign({ key: 'ff26beedd9ccfbf6621b267229991a328f1d2646', class: this.getClasses() }, this.inheritedAttributes), index.h("slot", { key: '4e75723c2e855ba1dddd837689acd3902063ed19' }, this.label))));
    }
    get el() { return index.getElement(this); }
};
ModusWCTypography.style = modusWcTypographyCss;

exports.modus_wc_panel = ModusWcPanel;
exports.modus_wc_typography = ModusWCTypography;
