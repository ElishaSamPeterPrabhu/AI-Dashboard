...
import { h as handleShadowDOMStyles } from './p-Cynmw4GD.js';
import { g as generateElementId, i as inheritAriaAttributes, b as inheritAttributes } from './p-CPG9FZRU.js';
import { d as defineCustomElement$3 } from './p-BZmq3r99.js';
import { d as defineCustomElement$2 } from './p-CUdHnVom.js';
import { d as defineCustomElement$1 } from './p-BbodYfU8.js';
...
const ModusWcTextInput = /*@__PURE__*/ proxyCustomElement(class ModusWcTextInput extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '08efb8d8b1802b5563abf3e93278aadf2a360ad6' }, this.label && (h("modus-wc-input-label", { key: '7d41ceb1e42256287c269fd92183e03871fe5fd0', forId: effectiveId, labelText: this.label, required: this.required, size: this.size })), h("label", { key: '1b53a067cca02831dba043f58f5d15590db5b2a6', class: this.getClasses() }, hasCustomIcon ? (h("div", { class: "modus-wc-text-input-icon modus-wc-text-input-icon-custom" }, h("slot", { name: "custom-icon" }))) : (this.includeSearch && (h(SearchSolidIcon, { className: "modus-wc-text-input-icon modus-wc-text-input-icon-search" }))), h("input", Object.assign({ key: '9a09e45373bacf5f3bffe519e2f5dec4699942d3', "aria-required": this.required, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, autocorrect: this.autoCorrect, class: "modus-wc-grow", disabled: this.disabled, enterkeyhint: this.enterkeyhint, id: effectiveId, maxlength: this.maxLength, minlength: this.minLength, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, pattern: this.pattern, placeholder: this.placeholder, readonly: this.readOnly, required: this.required, tabIndex: this.inputTabIndex, type: this.type, value: this.value }, this.inheritedAttributes)), this.includeClear && (h("div", { key: 'ec7a56940b19292f0f1ab4f97c9926ef1a664a31', class: `modus-wc-clear-icon-container ${showClear ? 'modus-wc-clear-icon-visible' : 'modus-wc-clear-icon-hidden'}` }, h(CloseSolidIcon, { key: 'd1f196d1a9825445dce45e596183189b3219c0c7', ariaLabel: this.clearAriaLabel, className: "modus-wc-text-input-icon modus-wc-text-input-icon-clear", decorative: false, onClear: this.handleClearText })))), this.feedback && (h("modus-wc-input-feedback", { key: '4c15132399331207e0f3dbcf7b451729a027c403', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return this; }
