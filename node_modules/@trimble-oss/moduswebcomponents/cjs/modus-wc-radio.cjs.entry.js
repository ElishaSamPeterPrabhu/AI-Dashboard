...
const ModusWcRadio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '73fd40e4f2b99da5d0f16457662e727c1fe357d0', class: "modus-wc-radio-host" }, index.h("input", Object.assign({ key: '3997d51c68ec38bcb882512e589ecdc1be1a020d', "aria-checked": this.value, "aria-disabled": this.disabled, checked: this.value, class: this.getClasses(), disabled: this.disabled, id: effectiveId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, required: this.required, tabIndex: this.inputTabIndex, type: "radio" }, this.inheritedAttributes)), this.label && (index.h("modus-wc-input-label", { key: 'aaf9b2c94ad856483850d76e65c7f79e09e0377e', forId: effectiveId, labelText: this.label, required: this.required, size: labelSize }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcRadio.style = modusWcRadioCss;

exports.modus_wc_radio = ModusWcRadio;
