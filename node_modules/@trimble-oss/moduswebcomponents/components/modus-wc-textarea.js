...
import { d as defineCustomElement$4 } from './p-BZmq3r99.js';
import { d as defineCustomElement$3 } from './p-CUdHnVom.js';
...
const ModusWcTextarea$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcTextarea extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return modusWcTextareaCss; }
}, [0, "modus-wc-textarea", {
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-textarea", "modus-wc-icon", "modus-wc-input-feedback", "modus-wc-input-label"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcTextarea$1);
            }
            break;
        case "modus-wc-icon":
            if (!customElements.get(tagName)) {
...
const ModusWcTextarea = ModusWcTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcTextarea, defineCustomElement };
