...
function processKeyEvent(event, params) {
    ...
    if ([utils.KEY.ArrowDown, utils.KEY.ArrowUp, utils.KEY.Enter, utils.KEY.Escape]
        .map((k) => k.toLowerCase())
        .includes(keyLower)) {
...
function renderNoResults(params) {
    var _a, _b, _c;
    return (index.h("div", { class: "modus-wc-autocomplete-no-results" },
        index.h("div", { class: "icon-label", "aria-label": (_a = params.noResults) === null || _a === void 0 ? void 0 : _a.ariaLabel },
            index.h(searchSolid_icon.SearchSolidIcon, { className: "modus-wc-autocomplete-search-icon" }),
            index.h("div", { class: "label" }, (_b = params.noResults) === null || _b === void 0 ? void 0 : _b.label)),
        index.h("div", { class: "sub-label" }, (_c = params.noResults) === null || _c === void 0 ? void 0 : _c.subLabel)));
}
function renderChips(params) {
    ...
    return (index.h(index.Fragment, null, visibleItems.map((item) => (index.h("modus-wc-chip", { "aria-label": "Remove item button", label: item.label, "show-remove": true, size: "sm", disabled: params.disabled || params.readOnly, onChipRemove: (event) => {
...
function renderClearButton(params) {
    ...
    return (index.h("modus-wc-button", { onClick: params.onClearAll, variant: "borderless", color: "tertiary", "aria-label": "Clear all", disabled: params.disabled || params.readOnly, size: "xs", shape: "circle", type: "button" },
        index.h(closeSolid_icon.CloseSolidIcon, null)));
}
function renderExpandCollapseButton(params) {
    ...
    return (index.h("modus-wc-button", { "custom-class": `modus-wc-autocomplete-expand-button ${params.isChipsExpanded ? 'expanded' : ''}`, onClick: params.onToggleExpansion, variant: "borderless", color: "tertiary", "aria-label": params.isChipsExpanded
            ? 'Collapse chips'
            : `Show ${remainingCount} more`, disabled: params.disabled || params.readOnly, size: "xs", shape: "circle", type: "button" },
        index.h("modus-wc-icon", { "aria-label": params.isChipsExpanded ? 'Collapse chips' : 'Expand chips', name: params.isChipsExpanded ? 'caret_up' : 'caret_down', size: "md" })));
}
...
function renderMenuItems(params) {
    ...
    return (index.h(index.Fragment, null, menuItems.length > 0 || !noResults || params.hasSlottedContent
        ? menuItems.map((item) => (index.h("modus-wc-menu-item", { checkbox: item.checkbox, disabled: item.disabled, focused: item.focused, label: item.label, onItemSelect: (e) => {
                e.stopPropagation();
...
const ModusWcAutocomplete = class {
    constructor(hostRef) {
        ...
        this.chipsExpansionChange = index.createEvent(this, "chipsExpansionChange");
    ...
    handleKeyDown(event) {
        ...
        switch (keyLower) {
            case utils.KEY.ArrowDown.toLowerCase(): {
                this.handleArrowDown();
                break;
            }
            case utils.KEY.ArrowUp.toLowerCase(): {
                this.handleArrowUp();
                break;
            }
            case utils.KEY.Escape.toLowerCase(): {
                this.handleEscape();
                break;
            }
            case utils.KEY.Enter.toLowerCase(): {
                this.handleEnter();
                break;
            }
            case utils.KEY.Backspace.toLowerCase(): {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8a8319d85917b6ad4dc57cea3a5ec96201fd8f29', class: this.getClasses(), style: cssVariables }, this.label && (index.h("modus-wc-input-label", { key: 'c6ce1ddf614242ea164dc8c0febc0022079c3ef9', customClass: this.feedback && (this.showFeedback || this.menuVisible)
                ? `modus-wc-input-label--${this.feedback.level}`
                : '', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), this.multiSelect ? (index.h("div", { class: this.getMultiSelectClasses() }, this.includeSearch && (index.h(searchSolid_icon.SearchSolidIcon, { className: "modus-wc-autocomplete-search-icon" })), index.h("div", { class: "modus-wc-autocomplete-content" }, renderChips({
            selectionOrder: this.selectionOrder,
            items: this.items,
        ...
        })), index.h("div", { class: "modus-wc-autocomplete-button-container" }, renderClearButton({
            includeClear: this.includeClear,
            disabled: this.disabled,
            readOnly: this.readOnly,
            selectionOrder: this.selectionOrder,
        ...
        })))) : (index.h(index.Fragment, null, renderInput({
            autoComplete: this.autoComplete,
            bordered: this.bordered,
            multiSelect: this.multiSelect,
            disabled: this.disabled,
            ...
            onFocus: this.handleFocus,
        }))), !this.multiSelect && this.feedback && this.showFeedback && (index.h("modus-wc-input-feedback", { key: '90c0f2036ce404b1a255d3590e38719858f7a090', level: this.feedback.level, message: this.feedback.message, size: this.size })), hasSlottedMenuItems ? (
        // When using custom slots, keep menu in DOM and use CSS to hide/show
        index.h("modus-wc-menu", { "aria-label": "Autocomplete menu", bordered: this.bordered, class: this.menuVisible ? 'menu-visible' : 'menu-hidden', onMenuFocusout: this.handleMenuFocusout, onMouseDown: (e) => e.preventDefault(), size: this.size }, renderMenuItems({
        ...
        }), index.h("slot", { name: "menu-items" }))) : (
        // When NOT using slots, conditionally render menu (automatic scroll reset)
        this.menuVisible && (index.h("modus-wc-menu", { "aria-label": "Autocomplete menu", bordered: this.bordered, class: "menu-visible", onMenuFocusout: this.handleMenuFocusout, onMouseDown: (e) => e.preventDefault(), size: this.size }, renderMenuItems({
            showSpinner: this.showSpinner,
            size: this.size,
            filteredItems: this.filteredItems,
            items: this.items,
            ...
            hasSlottedContent: hasSlottedMenuItems,
            onItemSelect: this.handleItemSelectByValue,
        }), index.h("slot", { name: "menu-items" })))), this.multiSelect && this.feedback && this.showFeedback && (index.h("modus-wc-input-feedback", { key: 'e7c72c9867b3635ffe1c3a34363aaa7edf6f4b80', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
...
exports.modus_wc_autocomplete = ModusWcAutocomplete;
