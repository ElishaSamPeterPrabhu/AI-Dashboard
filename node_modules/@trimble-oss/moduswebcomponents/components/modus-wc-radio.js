...
const ModusWcRadio$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcRadio extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return modusWcRadioCss; }
}, [0, "modus-wc-radio", {
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-radio", "modus-wc-input-label"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-radio":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcRadio$1);
            }
            break;
...
const ModusWcRadio = ModusWcRadio$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcRadio, defineCustomElement };
