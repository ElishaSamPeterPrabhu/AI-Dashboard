...
var baseComponent = require('./base-component-CB-UzuVm.js');
...
const ModusWcAvatar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8ac52db552b5093476ae19f158819a3c9d253ab3' }, index.h("div", Object.assign({ key: 'e3452c9c37a8adad4aaae454112f4020b7bf4f83', class: "modus-wc-avatar" }, this.inheritedAttributes), index.h("div", { key: 'eba4c00724a6f4dff7636d4a43fa46e93a28f75f', class: this.getClasses() }, this.imgSrc ? (index.h("img", { src: this.imgSrc, alt: altText })) : this.initials ? (index.h("span", { class: "initials", "aria-label": this.alt || this.initials }, this.getUserInitials())) : (index.h("modus-wc-icon", { "aria-label": altText, name: "person", size: this.size, variant: "solid" }))))));
    }
...
const ModusWcMenuItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3293649d5025d8ccddf05043da98cc478115ac98' }, index.h("li", Object.assign({ key: '47f3913a8ee4bdec1b119051e242a77272d9f535', "aria-checked": this.getAriaChecked(mode), "aria-selected": this.getAriaSelected(mode), "aria-disabled": this.disabled, class: this.getClasses(), role: this.getRole(mode), tabIndex: this.disabled ? -1 : 0 }, this.inheritedAttributes), index.h("button", { key: '88027a1860bc3874d0987788fdf6100923b381aa', class: this.getButtonClasses(), disabled: this.disabled, onClick: this.handleItemSelect, tabIndex: -1, type: "button" }, index.h("div", { key: 'f380403aa1a9c8bd528864d2c2b4bfa63ffe24ab', class: "modus-wc-menu-item-content" }, (this.checkbox || mode === 'multiple') && (index.h("modus-wc-checkbox", { key: 'e6290022bfaecbc52e54f2578aea204855975636', "aria-label": "Checkbox", disabled: this.disabled, size: this.size, value: !!this.selected })), index.h("slot", { key: '329ee90c09e721f8588331e10e2c8df34c5001f5', name: "start-icon" }), index.h("div", { key: 'f88c29f096c02581a038fbce3ce8261c8ee9ad88', class: "modus-wc-menu-item-labels" }, this.tooltipContent ? (index.h("modus-wc-tooltip", { content: this.tooltipContent, position: this.tooltipPosition, customClass: "modus-wc-menu-item-tooltip" }, index.h("div", null, this.label))) : (index.h("div", null, this.label)), this.subLabel && (index.h("div", { key: '2b5a36f7ed5c103967f701869d62be1b9f44c4b6', class: "modus-wc-menu-item-sublabel" }, this.subLabel))))), index.h("slot", { key: '04548946a7343d1f2e5fa4d8332c97680bd145b1' }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcMenuItem.style = modusWcMenuItemCss;

exports.modus_wc_avatar = ModusWcAvatar;
exports.modus_wc_menu_item = ModusWcMenuItem;
