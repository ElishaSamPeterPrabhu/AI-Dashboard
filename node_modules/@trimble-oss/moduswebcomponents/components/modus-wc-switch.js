...
import { D as DAISY_TO_MODUS_LABEL_SIZE } from './p-DZXd_sgn.js';
import { i as inheritAriaAttributes } from './p-CPG9FZRU.js';
import { d as defineCustomElement$2 } from './p-BbodYfU8.js';
...
const ModusWcSwitch$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcSwitch extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        return (h(Host, { key: '4ea43ec4f3a124389a3df2d452f5f3aeee602d7a', class: "modus-wc-switch-host" }, h("input", Object.assign({ key: '7cd58f67befb0c41d4ddb6521d39ab891c3132f7', "aria-checked": this.indeterminate ? 'mixed' : this.value, "aria-disabled": this.disabled, checked: this.value, class: this.getClasses(), disabled: this.disabled, id: this.inputId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, required: this.required, role: "switch", tabIndex: this.inputTabIndex, type: "checkbox" }, this.inheritedAttributes)), this.label && (h("modus-wc-input-label", { key: '8cb9fae7bd5ec5358ae8950f40f409d86bfadb6c', forId: this.inputId, labelText: this.label, required: this.required, size: labelSize }))));
    }
    get el() { return this; }
    static get style() { return modusWcSwitchCss; }
}, [0, "modus-wc-switch", {
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-switch", "modus-wc-input-label"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-switch":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcSwitch$1);
            }
            break;
...
const ModusWcSwitch = ModusWcSwitch$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcSwitch, defineCustomElement };
