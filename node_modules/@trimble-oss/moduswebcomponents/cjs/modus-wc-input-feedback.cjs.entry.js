...
const ModusWcInputFeedback = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8e3ab4b2d6c3b412dfc4e3a0b2250c9bd35af2ef' }, index.h("div", Object.assign({ key: 'd0f98f24f7f5998395d9e5b48206b9412d5a67ba', class: this.getClasses() }, this.inheritedAttributes), this.icon ? (index.h("modus-wc-icon", { decorative: true, name: this.icon })) : (this.getPresetIcon()), index.h("span", { key: '997c37332c46924cb7343b9795e6ead938b759f4' }, this.message))));
    }
