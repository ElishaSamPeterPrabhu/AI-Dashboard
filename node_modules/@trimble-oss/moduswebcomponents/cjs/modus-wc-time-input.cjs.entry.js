...
const ModusWcTimeInput = class {
    constructor(hostRef) {
         ...
         */
        this.internalDatalistId = `modus-wc-datalist-${utils.generateRandomId(10)}`;
    }
    componentWillLoad() {
    ...
    renderDatalist() {
        ...
        return (index.h("datalist", { id: this.internalDatalistId }, this.datalistOptions.map((time) => (index.h("option", { value: time })))));
    }
    render() {
        return (index.h(index.Host, { key: '0765a2fd72542f522e4317c488911357c9e07371' }, this.label && (index.h("modus-wc-input-label", { key: '113bab6244d974fe5640ec5786f33e8d1113828a', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), index.h("input", Object.assign({ key: '360b24527fb7d2b95db882ff90a2d161706a1adc', "aria-required": this.required, autocomplete: this.autoComplete, class: this.getClasses(), disabled: this.disabled, id: this.inputId, list: this.datalistId, max: this.max, min: this.min, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, readonly: this.readOnly, required: this.required, step: this.step || this.showSeconds ? 1 : 60, tabIndex: this.inputTabIndex, type: "time", value: this.value }, this.inheritedAttributes)), this.renderDatalist(), this.feedback && (index.h("modus-wc-input-feedback", { key: 'eff36a250933edd6de9cd3d613fc31c98d571dba', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcTimeInput.style = modusWcTimeInputCss;

exports.modus_wc_time_input = ModusWcTimeInput;
