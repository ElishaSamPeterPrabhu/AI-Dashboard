...
export class ModusWcLogo {
    ...
    render() {
        ...
        return (h(Host, { key: '4ca3a31d80602de0af4b035794564eeb8d94f297' }, h("span", Object.assign({ key: '1229795bdc165dfc8778a69d53cb0ee60a9ad8a5', class: `modus-wc-logo ${classes} ${this.emblem ? 'logo-emblem' : 'logo-full'} ${isCombined ? 'logo-combined' : ''}` }, this.inheritedAttributes, { role: "img", "aria-label": altText }), isCombined && (h("span", { key: '6e49f1524a0c0077028f3288b419939568f4cf07', class: "logo-combined-emblem" }, h(LogoSvg, { key: 'c7819d639fa3d0d8f0f05e18e951b7b31f1c5906', svgText: emblemSvgContent }))), h("span", { key: 'b53dd16ef78cd399149de813786b2977abc13679', class: isCombined ? 'logo-combined-wordmark' : '' }, h(LogoSvg, { key: '7441aaed4aee12689b0133981ec0a5c1337ba829', svgText: svgContent })))));
    }
