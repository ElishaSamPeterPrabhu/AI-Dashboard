...
import { d as defineCustomElement$2 } from './p-CNW7Gy06.js';
...
const ModusWcModal$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcModal extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return modusWcModalCss; }
}, [4, "modus-wc-modal", {
        "backdrop": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-modal", "modus-wc-button"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcModal$1);
            }
            break;
...
const ModusWcModal = ModusWcModal$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcModal, defineCustomElement };
